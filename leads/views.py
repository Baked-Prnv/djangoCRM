...
class LeadListView(LoginRequiredMixin, generic.ListView):
    ...
    #    'object_list' : leads
    #}
    #either use 'object_list' instead of 'leads' or we can change the name so that we dont have to specify in the html pages as well
    ...
    def get_queryset(self):
        ...
        if user.is_organiser:
            ...
            #filter on the basis of agent i.e., the logged in agent
